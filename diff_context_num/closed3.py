...
if __name__ == "__main__":
    ...
    np.savetxt('losses/closed3.txt', loss_traj)
    np.savetxt('svs3/closed3_shared.txt', sv_trajectory_plots)
    np.savetxt('svs3/closed3_d.txt', sv_trajectory_plots_d)
    np.savetxt('svs3/closed3_e.txt', sv_trajectory_plots_e)
    np.savetxt('svs3/closed3_f.txt', sv_trajectory_plots_f)  
